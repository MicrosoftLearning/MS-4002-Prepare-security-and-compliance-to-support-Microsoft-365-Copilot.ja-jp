...
4. 最初に、SharePoint と OneDrive に格納されている Office オンライン ファイルに対して秘密度ラベルを有効にします。 <br/>
    ...
    **Microsoft Purview** ポータルのナビゲーション ウィンドウの **[ソリューション]** セクションで、**[情報の保護]** を選択してから、**[秘密度ラベル]** を選択します。
...
2. Edge ブラウザーでは、前タスクの **Microsoft Purview** ポータルのタブがまだ開いているはずです。 **Microsoft Purview** ポータルのナビゲーション ウィンドウ内の **[情報保護]** グループで、**[秘密度ラベル]** を選択します。 
